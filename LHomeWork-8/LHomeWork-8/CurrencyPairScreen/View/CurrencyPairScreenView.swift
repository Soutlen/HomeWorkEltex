...
protocol CurrencyPairScreenViewInput: AnyObject {
    ...
    func updateCurrencyList(_ currencies: [CurrencyModel], showEmptyFavoritesPlaceholder: Bool)
}
...
private extension CurrencyPairScreenView {
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            favoriteFilterView.topAnchor.constraint(equalTo: stackViewTitle.bottomAnchor, constant: 12),
            favoriteFilterView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 24),
            favoriteFilterView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -24),
...
extension CurrencyPairScreenView: CurrencyPairScreenViewInput {
    ...
    func updateCurrencyList(_ currencies: [CurrencyModel], showEmptyFavoritesPlaceholder: Bool) {
        collectionView.configure(with: currencies, showEmptyFavoritesPlaceholder: showEmptyFavoritesPlaceholder)
        applySlotHighlight()
    }
}

extension CurrencyPairScreenView: CurrencyPairScreenFavoriteViewDelegate {
